      ...
      <ul class="mb-4 rounded-lg border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
        <li
          ...
          <input
            ...
            :name="task.id"
            type="checkbox"
            class="focus:ring-3 relative h-4 w-4 rounded-xs border border-gray-300 bg-gray-50 focus:ring-accent/40 dark:border-gray-700 dark:bg-gray-900 dark:ring-offset-gray-800 dark:focus:ring-accent/40"
            @change="toggle(task)" />
          ...
          <div>
            ...
            <div class="flex items-center text-sm">
              ...
              <div class="flex items-center">
                ...
                <Link :href="task.contact.url.show" class="text-accent hover:underline">
                  {{ task.contact.name }}
                </Link>
              </div>
            </div>
