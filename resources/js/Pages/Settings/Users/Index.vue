  ...
  <layout title="Dashboard" :layout-data="layoutData">
    ...
    <main class="relative">
      <div class="mx-auto max-w-3xl px-2 py-2 sm:px-6 sm:py-6 lg:px-8">
        ...
        <!-- list of users -->
        <ul class="user-list mb-6 rounded-lg border border-border bg-surface dark:border-border dark:bg-surface">
          <li
            v-for="user in data.users"
            :key="user.id"
            class="border-b border-border hover:bg-hover dark:border-border dark:bg-surface dark:hover:bg-hover">
              ...
              <div>
                ...
                <span class="block">
                  ...
                  <span
                    ...
                    class="ms-2 rounded-xs bg-bg px-2 py-1 text-xs text-text-muted"
                    >{{ $t('Administrator') }}</span
                  >
                </span>

                <!-- case : invitation sent -->
                <span class="relative text-sm text-text-muted">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
