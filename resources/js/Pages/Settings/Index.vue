  ...
  <Layout title="Dashboard" :layout-data="layoutData">
    ...
    <main class="relative">
      <div class="mx-auto max-w-md px-2 py-2 sm:px-6 sm:py-6 lg:px-8">
        ...
        <div class="mb-12 rounded-lg border border-border bg-surface p-5 dark:border-border dark:bg-surface">
          <ul>
        ...
        <div v-if="data.is_account_administrator">
          ...
          <div class="mb-6 rounded-lg border border-border bg-surface p-5 dark:border-border dark:bg-surface">
            <ul>
              <li class="mb-2 flex justify-start">
                <span class="me-2">😀</span>
