        ...
        <ul
          ...
          <li v-for="groupType in localGroupTypes" :key="groupType.id">
            ...
            <div
              ...
              :key="type.id"
              class="border-b border-border px-5 py-2 ps-6 hover:bg-hover dark:border-border dark:bg-surface dark:hover:bg-hover">
            ...
            <div
              ...
              class="item-list border-b border-border px-5 py-2 ps-6 hover:bg-hover dark:border-border dark:bg-surface dark:hover:bg-hover">
              <span
