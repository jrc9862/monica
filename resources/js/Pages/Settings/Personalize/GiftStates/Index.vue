          ...
          <draggable
            ...
            <template #item="{ element }">
              <div v-if="editGiftStateId !== element.id" class="list-icon">
                <div
                  class="item-list mb-2 flex items-center justify-between rounded-lg border border-border bg-surface py-2 pe-5 ps-4 hover:bg-hover dark:border-border dark:bg-surface dark:hover:bg-hover">
