<template>
  <div>
    ...
    <div
      ...
      class="mb-2 flex items-center rounded-lg border border-border bg-surface px-5 py-2 hover:cursor-pointer hover:bg-hover dark:border-border dark:bg-surface dark:hover:bg-hover"
    ...
    <draggable
      ...
      <template #item="{ element }">
        <div
          ...
          class="mb-2 flex items-center rounded-lg hover:cursor-pointer border border-border bg-surface py-2 pe-5 ps-2 hover:bg-hover dark:border-border dark:bg-surface dark:hover:bg-hover"
        ...
        <form
          v-else
          class="item-list mb-2 rounded-lg border border-border bg-surface hover:bg-hover dark:border-border dark:bg-surface dark:hover:bg-hover"
